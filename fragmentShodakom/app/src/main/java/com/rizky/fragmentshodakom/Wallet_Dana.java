...
public class Wallet_Dana extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wallet_dana);


        countdown=(TextView)findViewById(R.id.cd);

        new CountDownTimer(1800, 1000) { // adjust the milli seconds here
...
//        });
        ...
        Ib4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Wallet_Dana.this, Redirecting.class);
                startActivity(intent);
            }
        });
    }
