...
public class Wallet_Shopee extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wallet_shopee);
        ...
        Ib4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Wallet_Shopee.this, Redirecting.class);
